  ...
  <div class="chat-history" ref="chatHistoryRef">
    ...
    >
      ...
      <div class="message-content-wrapper">
        ...
        <!-- 加载状态显示 -->
        <div v-if="msg.status === 'loading'" class="message-content loading-content">
          <LoadingSpinner :is-loading="true" text="AI正在思考..." />
        </div>
        
        <!-- 普通消息内容（非作文批改时显示） -->
        <div v-else-if="!(msg.data && isEssayReview(msg.data))" class="message-content">
          {{ msg.content }}
        </div>
